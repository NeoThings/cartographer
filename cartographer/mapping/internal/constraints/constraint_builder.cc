...
proto::ConstraintBuilderOptions CreateConstraintBuilderOptions(
  ...
  options.set_max_constraint_candidates(
      parameter_dictionary->GetNonNegativeInt("max_constraint_candidates"));
  options.set_limit_global_constraint_distance(
      parameter_dictionary->GetBool("limit_global_constraint_distance"));
